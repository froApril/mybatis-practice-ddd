package xyf.tech.dev.test.domain;
...
import xyf.tech.domain.employee.service.IEmployeeService;
...
public class IEmployeeServiceTest {
    ...
    public void test_insertEmployInfo() {
        ...
        employeeInfo.setEmployeeNumber("100001113");
    ...
    public void test_queryEmployInfo() {
        EmployeeInfoEntity employeeInfoEntity = employeeService.queryEmployInfo("100001113");
